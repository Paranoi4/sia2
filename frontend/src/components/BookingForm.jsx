...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    const handleBeforeUnload = (event) => {
      ...
      if (storedBookingId) {
        axios.delete(`http://192.168.254.154:8000/api/delete-unpaid-booking/${storedBookingId}/`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post("http://192.168.254.154:8000/api/bookings/", {
            ...formData,
