...
function StockOutEvent() {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      // Filter only Stock-Out-Event transactions
      ...
      setFilteredTransactions(stockOutEventTransactions); // Set initial filtered data
      setIsLoading(false);
    } catch (error) {
  ...
  return (
    <div>
      <h1 className="text-4xl font-bold mb-4">Event Preparation Inventory</h1>
        ...
        <table className="table-auto w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="border border-gray-300 px-4 py-2">Stock-Out for Event</th>
